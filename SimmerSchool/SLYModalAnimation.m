...
-(void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext {
    ...
    if (self.type == AnimationTypePresent) {
        ...
        _constraints = [[NSLayoutConstraint constraintsWithVisualFormat:@"H:|-15-[modalView]-15-|" options:0 metrics:nil views:views] arrayByAddingObjectsFromArray:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-15-[modalView]-15-|" options:0 metrics:nil views:views]];
